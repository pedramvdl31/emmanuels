...
Vagrant.configure("2") do |config|
    config.vm.define :laravel4 do |lv4_config|
        ...
        lv4_config.vm.network :forwarded_port, guest: 80, host: 8383, auto_correct: true
        lv4_config.vm.network :forwarded_port, guest: 3306, host: 8890, auto_correct: true
        lv4_config.vm.network :forwarded_port, guest: 5432, host: 5435, auto_correct: true
