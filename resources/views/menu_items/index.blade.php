...
@stop
@section('scripts')
{!! Html::script('/assets/js/menu_items_index.js') !!}
@stop
@section('content')
<div class="jumbotron">
	<h1>Menu-Items</h1>
	<ol class="breadcrumb">
		...
		<li><a href="{!! action('MenuItemsController@getAdd',0) !!}">Add Menu Item</a></li>
	</ol>
		@if(isset($menu_items))
			...
			<div class="alert alert-warning" role="alert">
				...
				<a href="{!!action('MenuItemsController@getAdd',0)!!}" class="alert-link btn  btn-default" ><i class="glyphicon glyphicon-plus" aria-hidden="true"></i> Add Menu Item</a>
