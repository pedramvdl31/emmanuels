...
@section('content')
	...
	{{ Form::open(array('action' => 'ServicesController@postAdd', 'class'=>'','role'=>"form")) }}
	...
	<div class="panel-body">
		...
		<div class="form-group {{ $errors->has('rate') ? 'has-error' : false }}">
			...
			<div class="input-group">
				<input type="text" name="rate" class="form-control" aria-label="Amount (to the nearest dollar)" placeholder="00.0">
